			...
			<form id="form-summary" action="insertcompany">
				<table id="summary-table">
					<tr>
						...
						<td><input type="text" name="company_code" id="company_code"
							placeholder="Company code"></td>
					</tr>
					<tr>
					...
					<tr>
						<td><label for="sector_id">Sector Id</label></td>
					...
					<tr>
						<td><label for="stock_code">Stock Code</label></td>
